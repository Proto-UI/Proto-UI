...
[Base Table](/en/ui-libraries/base/table/) has a draft passive-structure protocol, a host-neutral Table Structure Module, five Base identities, and bounded Web Component ARIA projection evidence. It is not part of the released 0.2 package inventory, CLI facades, or interactive previews. React, Vue, Vue 2, CLI, and design-language work remain planned; the current slice is not a stable or cross-Adapter conformance claim.
