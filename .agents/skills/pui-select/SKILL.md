...
5. Prepare a task-specific probe proposal bound to the issue identity and update time, repository SHA, proposed scope, requested claim action, current permission facts, and contributor subject.
