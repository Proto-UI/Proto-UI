...
const cases = [
  ...
  // PR #625 A11y direct-reference transport on top of main 124f44c9: the merged
  // tree measures react 76,181 / vue 75,937 gzip bytes locally (Node v22.22.1,
  // zlib 1.3.1, esbuild 0.25.12, win32), above main's 75,000 ceiling. The delta
  // is the shared ownership transport in packages/adapters/base surfacing in
  // both adapters; wc stays within main's 86,000. Ceilings keep ~650-720 bytes
  // of headroom per the #654 evidence policy. See also budget-policy PR #665.
  ['adapter-react root', 'packages/adapters/react/src/index.ts', 76_900],
  ['adapter-vue root', 'packages/adapters/vue/src/index.ts', 76_600],
