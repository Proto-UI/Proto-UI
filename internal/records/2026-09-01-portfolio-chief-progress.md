...
## Exact-head re-review and Issue #587 delivery (2026-09-02)
...
- Issue #587 fixed on branch `fix/dropdown-mobile-drag-positioning-587`, signed commit `cd549b4b868ac4ee0f02913dd9aef1a2abbcb920`, PR https://github.com/Proto-UI/Proto-UI/pull/591. CI is green and @guangliang2019 review is requested. The Web host enables Floating UI frame tracking only for active pointer sessions and restores idle observation on pointerup/pointercancel/blur/target replacement/dispose; placement animation and dismissal semantics are unchanged. Unit evidence 5/5 + workspace types passed. Real 390×844 journey retained 4px gap through movement, flipped bottom→top at offset 320, and outside press dismissed open true→false. Authority gap recorded non-normatively at `internal/records/2026-09-02-dropdown-active-pointer-positioning.zh-CN.md`; T-ANCHORED-POSITIONING-0001 was intentionally left unchanged.
