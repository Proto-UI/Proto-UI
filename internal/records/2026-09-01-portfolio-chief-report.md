...
- **#587 → PR #591**: signed commit `cd549b4b`, green CI, reviewer requested. Active-pointer-only frame tracking restores Dropdown anchor cadence; pointercancel/blur/replacement/dispose covered; no placement animation or dismiss semantic change. Real 390×844 journey kept 4px gap, flipped bottom→top at offset 320, and preserved outside dismissal. PR: https://github.com/Proto-UI/Proto-UI/pull/591
